...
Weather Tab:
Grabs 10 day forecasts from 60 cities from around the world, and stores them. Then it compares the predictions to the actuals to compare whether analysts believe that it was hotter or cooler than expected. 

Fundamentals Tab:
Pulls an (http) *sigh* economic calendar that shows all fundamentals from fxstret.com
Due to it being http, all browsers block it, so I won't publish this - current - version to heroku.
